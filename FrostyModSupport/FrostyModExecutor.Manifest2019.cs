...
{
    private class Manifest2019 : IDisposable
    {
        ...
        public void ModSuperBundle(string inPath, SuperBundleInstallChunk inSbIc, SuperBundleModInfo inModInfo, InstallChunkWriter inInstallChunkWriter)
        {
    ...
    private void ModManifest2019(SuperBundleInstallChunk inSbIc, SuperBundleModInfo inModInfo, InstallChunkWriter inInstallChunkWriter)
    {
        ...
        {
            // TODO: create new patch superbundle
        }

        using (Manifest2019 action = new(m_modifiedEbx, m_modifiedRes, m_modifiedChunks))
        {
            action.ModSuperBundle(tocPath, inSbIc, inModInfo, inInstallChunkWriter);
